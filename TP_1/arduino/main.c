...
//Funcion para iniciar el circuito
void start()
{
...
//Funcion para reiniciar el circuito
void reset()
{
...
//Funcion para mostrar en consola los segundos y los num binarios
void mostrarConsola()
{
...
//Funcion para terminar el circuito
void cronoBinario()
{
  	start();
    reset();
